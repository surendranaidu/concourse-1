...
import (
	...
	bespec "github.com/concourse/concourse/worker/containerd/gardenbackend/spec"
...
//
func New(client containerdwrapper.Client, opts ...BackendOpt) (b Backend, err error) {
	if client == nil {
