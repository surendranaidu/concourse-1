...
import (
	...
	containerda "github.com/containerd/containerd"
	specs "github.com/opencontainers/runtime-spec/specs-go"
)

type FakeClient struct {
	ContainersStub        func(context.Context, ...string) ([]containerda.Container, error)
	...
	GetContainerStub        func(context.Context, string) (containerda.Container, error)
	...
	NewContainerStub        func(context.Context, string, map[string]string, *specs.Spec) (containerda.Container, error)
...
func (fake *FakeClient) Containers(arg1 context.Context, arg2 ...string) ([]containerda.Container, error) {
...
func (fake *FakeClient) ContainersCalls(stub func(context.Context, ...string) ([]containerda.Container, error)) {
	fake.containersMutex.Lock()
...
func (fake *FakeClient) ContainersReturns(result1 []containerda.Container, result2 error) {
	fake.containersMutex.Lock()
	defer fake.containersMutex.Unlock()
...
func (fake *FakeClient) ContainersReturnsOnCall(i int, result1 []containerda.Container, result2 error) {
	fake.containersMutex.Lock()
	defer fake.containersMutex.Unlock()
	fake.ContainersStub = nil
...
func (fake *FakeClient) GetContainer(arg1 context.Context, arg2 string) (containerda.Container, error) {
...
func (fake *FakeClient) GetContainerCalls(stub func(context.Context, string) (containerda.Container, error)) {
	fake.getContainerMutex.Lock()
...
func (fake *FakeClient) GetContainerReturns(result1 containerda.Container, result2 error) {
	fake.getContainerMutex.Lock()
	defer fake.getContainerMutex.Unlock()
...
func (fake *FakeClient) GetContainerReturnsOnCall(i int, result1 containerda.Container, result2 error) {
	fake.getContainerMutex.Lock()
	defer fake.getContainerMutex.Unlock()
	fake.GetContainerStub = nil
...
func (fake *FakeClient) NewContainer(arg1 context.Context, arg2 string, arg3 map[string]string, arg4 *specs.Spec) (containerda.Container, error) {
...
func (fake *FakeClient) NewContainerCalls(stub func(context.Context, string, map[string]string, *specs.Spec) (containerda.Container, error)) {
	fake.newContainerMutex.Lock()
...
func (fake *FakeClient) NewContainerReturns(result1 containerda.Container, result2 error) {
	fake.newContainerMutex.Lock()
	defer fake.newContainerMutex.Unlock()
...
func (fake *FakeClient) NewContainerReturnsOnCall(i int, result1 containerda.Container, result2 error) {
	fake.newContainerMutex.Lock()
	defer fake.newContainerMutex.Unlock()
	fake.NewContainerStub = nil
